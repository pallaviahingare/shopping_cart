...
if($con){
    ...
    $res = mysqli_query($con, "INSERT INTO products(id, name, actual_price, discount_price,description) values (null, '".$_POST['name']."', '".$_POST['actual_price']."', '".$_POST['discount_price']."', '".$_POST['description']."')");
